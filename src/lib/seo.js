...
const PERSON_DESC = {
  en: 'Computer science engineer, Founder & CEO of Obelysk. Building cognitive infrastructure, small language models, and advanced AI systems from El Salvador.',
  es: 'Ingeniero en ciencias de la computación, Fundador & CEO de Obelysk. Construyendo infraestructura cognitiva, modelos pequeños de lenguaje y sistemas avanzados de IA desde El Salvador.',
};
...
export function buildSiteGraphJsonLd(locale) {
  ...
  const person = {
    ...
    url,
    sameAs: SITE_SEO.sameAs,
    jobTitle: isEs ? 'Fundador & CEO de Obelysk' : 'Founder & CEO of Obelysk',
    worksFor: {
      '@type': 'Organization',
      name: 'Obelysk',
      url: 'https://www.obelysk.tech/',
      description: isEs
        ? 'Infraestructura cognitiva y modelos pequeños de lenguaje'
        : 'Cognitive infrastructure and small language models',
    },
    alumniOf: {
    ...
    knowsAbout: isEs
      ? ['Inteligencia Artificial', 'Modelos de Lenguaje', 'Ingeniería de software', 'Startups', 'Deep Tech', 'Infraestructura cognitiva']
      : ['Artificial Intelligence', 'Language Models', 'Software Engineering', 'Startups', 'Deep Tech', 'Cognitive Infrastructure'],
    description: personDesc,
  };
