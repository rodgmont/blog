    ...
    <article className="article-card">
      ...
      >
        ...
        <div className="article-card__body">
          ...
          {subtitle ? (
            <p className="text-muted article-card__subtitle" style={{ display: '-webkit-box', WebkitLineClamp: 1, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>{flattenInlineMarkdownLinks(subtitle)}</p>
          ) : null}
        </div>
