  ...
  return (
    <header className="site-header">
      <div className="site-header__inner container">
        <Link href={homePath(locale)} className="site-header__brand" style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
          {/* Nombre principal — bold heredado de .site-header__brand */}
          <span>Fran Rodgmont</span>

          {/* "Portfolio / Portafolio" — solo en rutas /portfolio y /portafolio */}
          {isPortfolio && (
            <span style={{ fontWeight: 300, fontSize: '1em', color: 'var(--muted)', letterSpacing: '0.01em' }}>
